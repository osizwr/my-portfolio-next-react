...
const projects = [
  ...
  },
  {
    ...
    gallery: [
      'https://images.unsplash.com/photo-1705909773420-8d7af2a343f9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaW5pbWFsJTIwd29ya3NwYWNlJTIwZGVzaWdufGVufDF8fHx8MTc1Nzk0MDkzMnww&ixlib=rb-4.1.0&q=80&w=1080'
    ],
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-light tracking-tight mb-6">
            All <span className="font-medium">Projects</span>
          </h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            These are my work showcasing my approach to design and development.
          </p>
        </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            >
              ...
              <div className="flex flex-col lg:flex-row h-full overflow-y-auto lg:overflow-hidden">
                ...
                <div className="lg:w-3/5 bg-black/5 relative group h-64 lg:h-auto min-h-[300px]">
                ...
                {/* Content Section */}
                <div className="lg:w-2/5 p-8 flex flex-col overflow-y-auto">
                  <div className="mb-6">
